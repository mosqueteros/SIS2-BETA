...
public class Administrador {
    ...
    public void registrarVentaContado(int idEmp, int idAuto, Float precio, String nombre, String apellidos, int ci, String fecha) {
        ...
        try {
            ...
            n = ps.executeUpdate();
            if (n > 0) {
                System.out.println("Funciono el registro de venta al contado");
            } else {
                System.out.println("NOOOOO funciono el registro de venta al contado");
            }
        } catch (Exception e) {
            System.out.println(e.toString());
        }
    ...
    public void registrar_compra(String nombre, int nit, int id_auto, float costo_unitario, int cantidad_auto, float precio_venta) {
        ...
        try {
            ...
            n = ps.executeUpdate();
            if (n > 0) {
                actualizar_automovil(id_auto, cantidad_auto);
            } else {
                System.out.println("NOOOOO");
            }
        } catch (Exception e) {
    ...
    public void actualizarPrecioVenta(float precio, int idAuto) {
        ...
        try {
            ...
            n = ps.executeUpdate();
            if (n > 0) {
                System.out.println("Funciono setear precio venta auto");
            } else {
                System.out.println("NOOOOO funciono setear precio venta auto");
            }
        } catch (Exception e) {
            System.out.println(e.toString());
        }
